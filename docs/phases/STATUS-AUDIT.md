...
| 10 — Fundaciones del modo owner                     | **En progreso**                                     | `docs/phases/phase-10-owner-foundations.md`                                                                                                                              | Sin PR todavía al momento de esta línea (actualizada 2026-07-25); numeración y alcance ya no son "post-Fase 9, TBD" — ver el plan file |
| 11-14 — resto del modo owner                        | **Pendiente** (no iniciada)                         | —                                                                                                                                                                        | —                                                                                                                                      |
...
| Punto de entrada a "modo owner" desde Perfil ("¿Tenés un negocio?")                                     | `docs/phases/phase-1-auth.md` — Notas/backlog                                    | Recortado explícitamente de la Fase 10 (decisión D2, alta solo por invitación) — diferido a la Fase 15 (post-MVP), `PLAN_MOBILE_CERQUITA.md`.                                                                                                                               |
...
6. **Fases 8 y 9, sin plan file ni código**: consistente con el flujo de planificación
   del proyecto (se planifican recién cuando se abordan), pero factualmente hoy no
   existe: checklist MASVS corrido, auditoría de accesibilidad dedicada, documentación
   formal de por qué ATT no aplica, ni ningún paso del checklist de publicación (cuenta
   de developer, certificados, assets de store, builds de producción, TestFlight/Internal
   testing, submit, revisión). (Nota: la fecha de esta auditoría es 2026-07-24; la Fase 10
   del modo owner arrancó el 2026-07-25 y ya tiene plan file y código en progreso — ver
   la fila actualizada en la sección 1.)
