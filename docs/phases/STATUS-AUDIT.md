...
| 7b — Recuperación de contraseña                     | **Pendiente** (no iniciada)                         | —                                                                                                                                                                        | —                                                                                                                                      |
...
| Flujo de recuperación de contraseña (Clerk reset por código) + restaurar el link "¿Olvidaste tu contraseña?" | `docs/phases/chore-brand-v2-login-splash.md` (Checkpoint C), anotado en `PLAN_MOBILE_CERQUITA.md` | El link se omitió a propósito al rediseñar el login (dirección 8b) por no tener flujo detrás.                                                                                                                                                                               |
